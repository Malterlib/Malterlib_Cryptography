...
#		endif
		...
		public:
			...
			TCBinaryStream_Encrypted(NNet::CEncryptKeyIV const &_KeyIV, NNet::ESSLDigest _HMAC, NContainer::CSecureByteVector const &_HMACKey);
		...
		private:
			...
			NPtr::TCUniquePointer<NNet::CIncrementalEncrypt> mp_pEncryptContext;
			NPtr::TCUniquePointer<NNet::CIncrementalHMAC> mp_pHMACContext;

			NContainer::CSecureByteVector mp_DecryptedBlock;
			NContainer::CSecureByteVector mp_TempBlock;
			NNet::CEncryptKeyIV const mp_KeyIV;
